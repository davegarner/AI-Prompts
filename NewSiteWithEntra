-----------------------------------------------------
Fallout Based Green Terminal Web Template Prompt

New Prompt testing entra id without tube status
-----------------------------------------------------
...
Theme support for different hues and operator preferences
Each Page is templated and can be duplicated when additional pages are required
Navigation links can be updated easily from a central point such as the headder
Allow for display on Mobile OS
entra ID integration for secure site
...
Create login page that integrates to entra ID
