...
Please use api's from blockchain.com as well as my personal api keys from coinbase

Please create a home page which links to  all of the pages:

I would like to see a main dashboard with the following:
Bitcoin:
...
Price chart for the current day which is interactive which should be in USD, allow for a dropdown to change currency to GBP, NZD, AUD, CAD and SGD

Other dashboards should include:
...
Assign a chart for each pair for the current day pricing

Currency Statistics:
Total circulating bitcoins
market price usd
market cap usd
